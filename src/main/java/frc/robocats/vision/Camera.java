...
public class Camera {
   ...
   * 
   * @param id The id of the tag you're looking at
  ...
  public double getDistanceMeters(int id) {
    ...
    double h2 = 1; // TODO find tagHeight
...
// {{ get
     ...
     * 
     * @param id The id of the April tag you're looking for; null if these are not the tags you are looking for
     *           {@link https://www.youtube.com/watch?v=532j-186xEQ}
     * @return The Tracked Target of a april tag with a certain Id
     */
