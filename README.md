...
After using this command, you will then have to change the branch to main. [insert gif of doing this here]
...
- First, you need to make sure you are pushing to a branch not a commit. ex: main not 48858ec [insert gif of doing this here]
